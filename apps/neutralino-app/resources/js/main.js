...
// Neutralino.app.readProcessInput().then((data) => {
//     console.log('Received data from the process:', data);
//     document.getElementById('info').innerHTML += `
//     <p>Received data from the process: ${data}</p>
//     `;
// });

// parameter is readAll: true
Neutralino.app.readProcessInput(true).then((data) => {
    console.log('HERE COMES DATA', data)
    document.getElementById('info').innerHTML += `
    <p>[readall: true] Received data from the process: ${data}</p>
    `;


    Neutralino.app.writeProcessOutput(`Hello ${data}\n`);
});
